...
export const spots: Spot[] = [
  {
    ...
    area: 'west',
    description:
      'ライブ会場です。日向サンマリンスタジアム宮崎周辺を代表地点として表示します。',
    memo: '実際の入場口、退場導線、規制エリアは公式案内が出たら更新してください。',
    latitude: 31.830753,
    longitude: 131.445896,
    coordinateStatus: 'approximate',
    tags: ['ライブ', 'メイン会場', '日向サンマリンスタジアム宮崎'],
    isImportant: true,
    sortOrder: 10,
  },
  {
    ...
    area: 'center',
    description:
      '第2陸上競技場周辺で開催されるエリアです。飲食店、ひなあいエリアなどの確認用スポットです。',
    memo: '出店や企画の詳細位置は、追加の公式発表後にブースデータ側と連携して更新します。',
    latitude: 31.826564,
    longitude: 131.44871,
    coordinateStatus: 'approximate',
    tags: ['ひなたエキスポ', '飲食', 'ひなあいエリア', '第2陸上競技場'],
    isImportant: true,
    sortOrder: 20,
  },
  {
    ...
    area: 'east',
    description:
      'ひなた木の花ドーム周辺で開催されるエリアです。グッズ販売、FCブースなどの確認用スポットです。',
    memo: 'グッズ販売時間、整理券、決済方法、FCブースの詳細は公式案内を優先してください。',
    latitude: 31.820917,
    longitude: 131.448806,
    coordinateStatus: 'approximate',
    tags: ['ひなたモール', 'グッズ', 'FCブース', 'ひなた木の花ドーム'],
    isImportant: true,
    sortOrder: 30,
  },
  {
    ...
    area: 'east',
    description:
      '宮崎県青島青少年自然の家の運動広場周辺で開催されるキャンプエリアです。',
    memo: 'キャンプ受付、入退場、利用ルールなどは公式案内を確認してください。',
    latitude: 31.819607,
    longitude: 131.449482,
    coordinateStatus: 'approximate',
    tags: ['キャンプ', '手ぶらキャンプ', '青島青少年自然の家', '運動広場'],
    isImportant: true,
    sortOrder: 40,
  },
  {
